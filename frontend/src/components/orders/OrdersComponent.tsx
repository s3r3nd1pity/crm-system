            ...
            {loading ? (
                ...
                <>
                    <div className="w-full overflow-x-auto rounded-2xl shadow-md">
                        <table className="w-full table-fixed border-collapse bg-white min-w-[1000px]">
                            <thead
                                className="bg-pink-200 select-none text-[0.75rem] sm:text-[0.85rem] md:text-[0.95rem]">
                            <tr>
                                {[
                                    'id',
                                    'name',
